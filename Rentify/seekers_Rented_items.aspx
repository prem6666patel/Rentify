<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="seekers_Rented_items.aspx.cs" Inherits="Rentify.seekers_Rented_items" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>seekers Rented items</title>
    <style>
        body {
                ...
                <div class="left-panel">
                    ...
                    <div class="personal-details">
                        ...
                        <p>
                            ...
                            <asp:Label ID="lblpass" runat="server" ForeColor="black"></asp:Label>
                        </p>
                            ...
                            <ItemTemplate>
                                <div class="item" style="display: flex; align-items: flex-start; gap: 15px;">
                                    ...
                                    <div style="flex: 2;" class="DivDetails">
                                        ...
                                        <p><strong>Item id:</strong> <%# Eval("item_id") %></p>
                                        <p><strong>Item Name:</strong> <%# Eval("item_name") %></p>
                                       <p><strong>seeker id:</strong> <%# Eval("seeker_id") %></p>
                                        <p><strong>seeker name :</strong> <%# Eval("fullname") %></p>
                                         <p><strong>seeker email id :</strong> <%# Eval("email") %></p>
                                         <p><strong>seeker email contact :</strong> <%# Eval("contact") %></p>
                                       <p><strong>renting start date:</strong> <%# Eval("start_date") %></p>
                                         <p><strong>renting end date:</strong> <%# Eval("end_date") %></p>
                                         <p><strong>returned ? :</strong> <%# Eval("returned") %></p>
                                    </div>
                                </div>
                            </ItemTemplate>
                        </asp:Repeater>
