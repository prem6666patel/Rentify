<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="seekers_details.aspx.cs" Inherits="Rentify.seekers_details" %>
                         ...
                         <ItemTemplate>
                             <div class="item" style="display: flex; align-items: flex-start; gap: 15px;">
                                 ...
                                 <div style="flex: 2;" class="DivDetails">
                                     ...
                                     <p><strong>id  : </strong> <%# Eval("s_id") %></p>
