...
namespace Rentify
{
    public partial class seekers_Rented_items : System.Web.UI.Page
    {
        int p_id;
        ...
        {
            string qryItems = "SELECT * from [transaction] t join tbl_item i on t.item_id = i.item_id join tbl_seekers s on s.s_id = t.seeker_id";
